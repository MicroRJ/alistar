...
inline bool AbilityData_Target_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, AbilityData_Target* value) {
...
inline bool Weapon_TargetType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, Weapon_TargetType* value) {
...
inline bool Attribute_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, Attribute* value) {
...
class AbilityData final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_button_name(ArgT0&& arg0, ArgT... args);
  std::string* mutable_button_name();
  PROTOBUF_NODISCARD std::string* release_button_name();
  void set_allocated_button_name(std::string* button_name);
  private:
  const std::string& _internal_button_name() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_button_name(const std::string& value);
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_hotkey(ArgT0&& arg0, ArgT... args);
  std::string* mutable_hotkey();
  PROTOBUF_NODISCARD std::string* release_hotkey();
  void set_allocated_hotkey(std::string* hotkey);
  private:
  const std::string& _internal_hotkey() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_hotkey(const std::string& value);
  ...
  uint32_t remaps_to_ability_id() const;
  void set_remaps_to_ability_id(uint32_t value);
  private:
  uint32_t _internal_remaps_to_ability_id() const;
  void _internal_set_remaps_to_ability_id(uint32_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    uint32_t remaps_to_ability_id_;
    bool available_;
    bool allow_minimap_;
...
class DamageBonus final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:SC2APIProtocol.DamageBonus) */ {
 public:
  inline DamageBonus() : DamageBonus(nullptr) {}
  ~DamageBonus() override;
  explicit PROTOBUF_CONSTEXPR DamageBonus(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(DamageBonus* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  DamageBonus* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const DamageBonus& from) {
    DamageBonus::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  protected:
  explicit DamageBonus(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class Weapon final :
 ...
 public:
  ...
  void set_attacks(uint32_t value);
  private:
  uint32_t _internal_attacks() const;
  void _internal_set_attacks(uint32_t value);
  public:
...
class UnitTypeData final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:SC2APIProtocol.UnitTypeData) */ {
 public:
  inline UnitTypeData() : UnitTypeData(nullptr) {}
  ~UnitTypeData() override;
  explicit PROTOBUF_CONSTEXPR UnitTypeData(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(UnitTypeData* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  UnitTypeData* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const UnitTypeData& from) {
    UnitTypeData::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  protected:
  explicit UnitTypeData(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  private:
  uint32_t _internal_tech_alias(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >&
      _internal_tech_alias() const;
  void _internal_add_tech_alias(uint32_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >*
      _internal_mutable_tech_alias();
  public:
  uint32_t tech_alias(int index) const;
  void set_tech_alias(int index, uint32_t value);
  void add_tech_alias(uint32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >&
      tech_alias() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >*
      mutable_tech_alias();
  ...
  uint32_t cargo_size() const;
  void set_cargo_size(uint32_t value);
  private:
  uint32_t _internal_cargo_size() const;
  void _internal_set_cargo_size(uint32_t value);
  public:
  ...
  uint32_t mineral_cost() const;
  void set_mineral_cost(uint32_t value);
  private:
  uint32_t _internal_mineral_cost() const;
  void _internal_set_mineral_cost(uint32_t value);
  public:
  ...
  uint32_t vespene_cost() const;
  void set_vespene_cost(uint32_t value);
  private:
  uint32_t _internal_vespene_cost() const;
  void _internal_set_vespene_cost(uint32_t value);
  public:
  ...
  uint32_t unit_alias() const;
  void set_unit_alias(uint32_t value);
  private:
  uint32_t _internal_unit_alias() const;
  void _internal_set_unit_alias(uint32_t value);
  public:
  ...
  uint32_t tech_requirement() const;
  void set_tech_requirement(uint32_t value);
  private:
  uint32_t _internal_tech_requirement() const;
  void _internal_set_tech_requirement(uint32_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t > tech_alias_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr name_;
    uint32_t unit_id_;
    uint32_t cargo_size_;
    float movement_speed_;
    float armor_;
    uint32_t mineral_cost_;
    uint32_t vespene_cost_;
    ...
    uint32_t unit_alias_;
    uint32_t tech_requirement_;
    float sight_range_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_s2clientprotocol_2fdata_2eproto;
...
class UpgradeData final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:SC2APIProtocol.UpgradeData) */ {
 public:
  inline UpgradeData() : UpgradeData(nullptr) {}
  ~UpgradeData() override;
  explicit PROTOBUF_CONSTEXPR UpgradeData(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(UpgradeData* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  UpgradeData* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const UpgradeData& from) {
    UpgradeData::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  protected:
  explicit UpgradeData(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class EffectData final :
 ...
 public:
  ...
  void MergeFrom( const EffectData& from) {
    EffectData::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
inline uint32_t AbilityData::_internal_ability_id() const {
  return _impl_.ability_id_;
}
inline uint32_t AbilityData::ability_id() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.AbilityData.ability_id)
  return _internal_ability_id();
}
inline void AbilityData::_internal_set_ability_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.ability_id_ = value;
}
inline void AbilityData::set_ability_id(uint32_t value) {
...
void AbilityData::set_link_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
...
inline std::string* AbilityData::release_link_name() {
  ...
  _impl_._has_bits_[0] &= ~0x00000001u;
  auto* p = _impl_.link_name_.Release();
...
inline uint32_t AbilityData::_internal_link_index() const {
  return _impl_.link_index_;
}
inline uint32_t AbilityData::link_index() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.AbilityData.link_index)
  return _internal_link_index();
}
inline void AbilityData::_internal_set_link_index(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000020u;
  _impl_.link_index_ = value;
}
inline void AbilityData::set_link_index(uint32_t value) {
...
inline void AbilityData::clear_button_name() {
  _impl_.button_name_.ClearToEmpty();
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AbilityData::set_button_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
 _impl_.button_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:SC2APIProtocol.AbilityData.button_name)
}
inline std::string* AbilityData::mutable_button_name() {
  std::string* _s = _internal_mutable_button_name();
...
inline const std::string& AbilityData::_internal_button_name() const {
  return _impl_.button_name_.Get();
}
inline void AbilityData::_internal_set_button_name(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.button_name_.Set(value, GetArenaForAllocation());
}
inline std::string* AbilityData::_internal_mutable_button_name() {
  _impl_._has_bits_[0] |= 0x00000002u;
  return _impl_.button_name_.Mutable(GetArenaForAllocation());
}
inline std::string* AbilityData::release_button_name() {
  ...
  _impl_._has_bits_[0] &= ~0x00000002u;
  auto* p = _impl_.button_name_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.button_name_.IsDefault()) {
...
inline void AbilityData::set_allocated_button_name(std::string* button_name) {
  ...
  _impl_.button_name_.SetAllocated(button_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.button_name_.IsDefault()) {
    _impl_.button_name_.Set("", GetArenaForAllocation());
  }
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AbilityData::set_friendly_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000004u;
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AbilityData::set_hotkey(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000008u;
 _impl_.hotkey_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:SC2APIProtocol.AbilityData.hotkey)
}
inline std::string* AbilityData::mutable_hotkey() {
  std::string* _s = _internal_mutable_hotkey();
...
inline const std::string& AbilityData::_internal_hotkey() const {
  return _impl_.hotkey_.Get();
}
inline void AbilityData::_internal_set_hotkey(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.hotkey_.Set(value, GetArenaForAllocation());
}
inline std::string* AbilityData::_internal_mutable_hotkey() {
  _impl_._has_bits_[0] |= 0x00000008u;
  return _impl_.hotkey_.Mutable(GetArenaForAllocation());
}
inline std::string* AbilityData::release_hotkey() {
  ...
  _impl_._has_bits_[0] &= ~0x00000008u;
  auto* p = _impl_.hotkey_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.hotkey_.IsDefault()) {
...
inline void AbilityData::set_allocated_hotkey(std::string* hotkey) {
  ...
  _impl_.hotkey_.SetAllocated(hotkey, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.hotkey_.IsDefault()) {
    _impl_.hotkey_.Set("", GetArenaForAllocation());
  }
...
inline void AbilityData::clear_remaps_to_ability_id() {
  _impl_.remaps_to_ability_id_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000040u;
}
inline uint32_t AbilityData::_internal_remaps_to_ability_id() const {
  return _impl_.remaps_to_ability_id_;
}
inline uint32_t AbilityData::remaps_to_ability_id() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.AbilityData.remaps_to_ability_id)
  return _internal_remaps_to_ability_id();
}
inline void AbilityData::_internal_set_remaps_to_ability_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000040u;
  _impl_.remaps_to_ability_id_ = value;
}
inline void AbilityData::set_remaps_to_ability_id(uint32_t value) {
...
inline ::SC2APIProtocol::AbilityData_Target AbilityData::_internal_target() const {
  return static_cast< ::SC2APIProtocol::AbilityData_Target >(_impl_.target_);
}
...
inline void AbilityData::_internal_set_footprint_radius(float value) {
  _impl_._has_bits_[0] |= 0x00000800u;
  _impl_.footprint_radius_ = value;
}
...
inline void AbilityData::clear_is_instant_placement() {
  _impl_.is_instant_placement_ = false;
  _impl_._has_bits_[0] &= ~0x00001000u;
}
inline bool AbilityData::_internal_is_instant_placement() const {
  return _impl_.is_instant_placement_;
}
...
inline void AbilityData::_internal_set_is_instant_placement(bool value) {
  _impl_._has_bits_[0] |= 0x00001000u;
  _impl_.is_instant_placement_ = value;
}
...
inline ::SC2APIProtocol::Attribute DamageBonus::_internal_attribute() const {
  return static_cast< ::SC2APIProtocol::Attribute >(_impl_.attribute_);
}
...
inline ::SC2APIProtocol::Weapon_TargetType Weapon::_internal_type() const {
  return static_cast< ::SC2APIProtocol::Weapon_TargetType >(_impl_.type_);
}
...
inline int Weapon::_internal_damage_bonus_size() const {
  return _impl_.damage_bonus_.size();
}
...
inline ::SC2APIProtocol::DamageBonus* Weapon::mutable_damage_bonus(int index) {
  ...
  return _impl_.damage_bonus_.Mutable(index);
}
...
inline ::SC2APIProtocol::DamageBonus* Weapon::_internal_add_damage_bonus() {
  return _impl_.damage_bonus_.Add();
}
inline ::SC2APIProtocol::DamageBonus* Weapon::add_damage_bonus() {
  ::SC2APIProtocol::DamageBonus* _add = _internal_add_damage_bonus();
...
inline uint32_t Weapon::_internal_attacks() const {
  return _impl_.attacks_;
}
inline uint32_t Weapon::attacks() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.Weapon.attacks)
  return _internal_attacks();
}
inline void Weapon::_internal_set_attacks(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.attacks_ = value;
}
inline void Weapon::set_attacks(uint32_t value) {
...
inline uint32_t UnitTypeData::_internal_unit_id() const {
  return _impl_.unit_id_;
}
inline uint32_t UnitTypeData::unit_id() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.UnitTypeData.unit_id)
  return _internal_unit_id();
}
inline void UnitTypeData::_internal_set_unit_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.unit_id_ = value;
}
inline void UnitTypeData::set_unit_id(uint32_t value) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void UnitTypeData::set_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
...
inline void UnitTypeData::clear_cargo_size() {
  _impl_.cargo_size_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline uint32_t UnitTypeData::_internal_cargo_size() const {
  return _impl_.cargo_size_;
}
inline uint32_t UnitTypeData::cargo_size() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.UnitTypeData.cargo_size)
  return _internal_cargo_size();
}
inline void UnitTypeData::_internal_set_cargo_size(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.cargo_size_ = value;
}
inline void UnitTypeData::set_cargo_size(uint32_t value) {
...
inline void UnitTypeData::clear_mineral_cost() {
  _impl_.mineral_cost_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000020u;
}
inline uint32_t UnitTypeData::_internal_mineral_cost() const {
  return _impl_.mineral_cost_;
}
inline uint32_t UnitTypeData::mineral_cost() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.UnitTypeData.mineral_cost)
  return _internal_mineral_cost();
}
inline void UnitTypeData::_internal_set_mineral_cost(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000020u;
  _impl_.mineral_cost_ = value;
}
inline void UnitTypeData::set_mineral_cost(uint32_t value) {
...
inline void UnitTypeData::clear_vespene_cost() {
  _impl_.vespene_cost_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000040u;
}
inline uint32_t UnitTypeData::_internal_vespene_cost() const {
  return _impl_.vespene_cost_;
}
inline uint32_t UnitTypeData::vespene_cost() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.UnitTypeData.vespene_cost)
  return _internal_vespene_cost();
}
inline void UnitTypeData::_internal_set_vespene_cost(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000040u;
  _impl_.vespene_cost_ = value;
}
inline void UnitTypeData::set_vespene_cost(uint32_t value) {
...
inline uint32_t UnitTypeData::_internal_ability_id() const {
  return _impl_.ability_id_;
}
inline uint32_t UnitTypeData::ability_id() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.UnitTypeData.ability_id)
  return _internal_ability_id();
}
inline void UnitTypeData::_internal_set_ability_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000100u;
  _impl_.ability_id_ = value;
}
inline void UnitTypeData::set_ability_id(uint32_t value) {
  _internal_set_ability_id(value);
...
inline void UnitTypeData::clear_has_minerals() {
  _impl_.has_minerals_ = false;
  _impl_._has_bits_[0] &= ~0x00001000u;
}
inline bool UnitTypeData::_internal_has_minerals() const {
  return _impl_.has_minerals_;
}
...
inline int UnitTypeData::_internal_tech_alias_size() const {
  return _impl_.tech_alias_.size();
}
...
inline uint32_t UnitTypeData::_internal_tech_alias(int index) const {
  return _impl_.tech_alias_.Get(index);
}
inline uint32_t UnitTypeData::tech_alias(int index) const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.UnitTypeData.tech_alias)
  return _internal_tech_alias(index);
}
inline void UnitTypeData::set_tech_alias(int index, uint32_t value) {
  _impl_.tech_alias_.Set(index, value);
  // @@protoc_insertion_point(field_set:SC2APIProtocol.UnitTypeData.tech_alias)
}
inline void UnitTypeData::_internal_add_tech_alias(uint32_t value) {
  _impl_.tech_alias_.Add(value);
}
inline void UnitTypeData::add_tech_alias(uint32_t value) {
...
inline void UnitTypeData::clear_unit_alias() {
  _impl_.unit_alias_ = 0u;
  _impl_._has_bits_[0] &= ~0x00010000u;
}
inline uint32_t UnitTypeData::_internal_unit_alias() const {
  return _impl_.unit_alias_;
}
inline uint32_t UnitTypeData::unit_alias() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.UnitTypeData.unit_alias)
  return _internal_unit_alias();
}
inline void UnitTypeData::_internal_set_unit_alias(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00010000u;
  _impl_.unit_alias_ = value;
}
inline void UnitTypeData::set_unit_alias(uint32_t value) {
...
inline void UnitTypeData::clear_tech_requirement() {
  _impl_.tech_requirement_ = 0u;
  _impl_._has_bits_[0] &= ~0x00020000u;
}
inline uint32_t UnitTypeData::_internal_tech_requirement() const {
  return _impl_.tech_requirement_;
}
inline uint32_t UnitTypeData::tech_requirement() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.UnitTypeData.tech_requirement)
  return _internal_tech_requirement();
}
inline void UnitTypeData::_internal_set_tech_requirement(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00020000u;
  _impl_.tech_requirement_ = value;
}
inline void UnitTypeData::set_tech_requirement(uint32_t value) {
...
inline void UnitTypeData::clear_require_attached() {
  _impl_.require_attached_ = false;
  _impl_._has_bits_[0] &= ~0x00002000u;
}
inline bool UnitTypeData::_internal_require_attached() const {
  return _impl_.require_attached_;
}
...
inline void UnitTypeData::_internal_set_require_attached(bool value) {
  _impl_._has_bits_[0] |= 0x00002000u;
  _impl_.require_attached_ = value;
}
...
inline ::SC2APIProtocol::Attribute UnitTypeData::_internal_attributes(int index) const {
  return static_cast< ::SC2APIProtocol::Attribute >(_impl_.attributes_.Get(index));
}
...
inline ::SC2APIProtocol::Weapon* UnitTypeData::add_weapons() {
  ::SC2APIProtocol::Weapon* _add = _internal_add_weapons();
...
inline uint32_t UpgradeData::_internal_upgrade_id() const {
  return _impl_.upgrade_id_;
}
inline uint32_t UpgradeData::upgrade_id() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.UpgradeData.upgrade_id)
  return _internal_upgrade_id();
}
inline void UpgradeData::_internal_set_upgrade_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.upgrade_id_ = value;
}
inline void UpgradeData::set_upgrade_id(uint32_t value) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void UpgradeData::set_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline uint32_t UpgradeData::_internal_mineral_cost() const {
  return _impl_.mineral_cost_;
}
inline uint32_t UpgradeData::mineral_cost() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.UpgradeData.mineral_cost)
  return _internal_mineral_cost();
}
inline void UpgradeData::_internal_set_mineral_cost(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.mineral_cost_ = value;
}
inline void UpgradeData::set_mineral_cost(uint32_t value) {
  _internal_set_mineral_cost(value);
...
inline uint32_t UpgradeData::_internal_vespene_cost() const {
  return _impl_.vespene_cost_;
}
inline uint32_t UpgradeData::vespene_cost() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.UpgradeData.vespene_cost)
  return _internal_vespene_cost();
}
inline void UpgradeData::_internal_set_vespene_cost(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.vespene_cost_ = value;
}
inline void UpgradeData::set_vespene_cost(uint32_t value) {
  _internal_set_vespene_cost(value);
...
inline uint32_t UpgradeData::_internal_ability_id() const {
  return _impl_.ability_id_;
}
inline uint32_t UpgradeData::ability_id() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.UpgradeData.ability_id)
  return _internal_ability_id();
}
inline void UpgradeData::_internal_set_ability_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000020u;
  _impl_.ability_id_ = value;
}
inline void UpgradeData::set_ability_id(uint32_t value) {
  _internal_set_ability_id(value);
...
inline uint32_t BuffData::_internal_buff_id() const {
  return _impl_.buff_id_;
}
inline uint32_t BuffData::buff_id() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.BuffData.buff_id)
  return _internal_buff_id();
}
inline void BuffData::_internal_set_buff_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.buff_id_ = value;
}
inline void BuffData::set_buff_id(uint32_t value) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void BuffData::set_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline uint32_t EffectData::_internal_effect_id() const {
  return _impl_.effect_id_;
}
inline uint32_t EffectData::effect_id() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.EffectData.effect_id)
  return _internal_effect_id();
}
inline void EffectData::_internal_set_effect_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.effect_id_ = value;
}
inline void EffectData::set_effect_id(uint32_t value) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void EffectData::set_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void EffectData::set_friendly_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
 _impl_.friendly_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
