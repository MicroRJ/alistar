...
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_s2clientprotocol_2ferror_2eproto[1];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_s2clientprotocol_2ferror_2eproto = nullptr;
const uint32_t TableStruct_s2clientprotocol_2ferror_2eproto::offsets[1] = {};
static constexpr ::_pbi::MigrationSchema* schemas = nullptr;
static constexpr ::_pb::Message* const* file_default_instances = nullptr;

const char descriptor_table_protodef_s2clientprotocol_2ferror_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "lOrder\020\326\001"
  ;
static ::_pbi::once_flag descriptor_table_s2clientprotocol_2ferror_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_s2clientprotocol_2ferror_2eproto = {
    false, false, 5849, descriptor_table_protodef_s2clientprotocol_2ferror_2eproto,
    "s2clientprotocol/error.proto",
    &descriptor_table_s2clientprotocol_2ferror_2eproto_once, nullptr, 0, 0,
    schemas, file_default_instances, TableStruct_s2clientprotocol_2ferror_2eproto::offsets,
    nullptr, file_level_enum_descriptors_s2clientprotocol_2ferror_2eproto,
    file_level_service_descriptors_s2clientprotocol_2ferror_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_s2clientprotocol_2ferror_2eproto_getter() {
  return &descriptor_table_s2clientprotocol_2ferror_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_s2clientprotocol_2ferror_2eproto(&descriptor_table_s2clientprotocol_2ferror_2eproto);
namespace SC2APIProtocol {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ActionResult_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_s2clientprotocol_2ferror_2eproto);
  return file_level_enum_descriptors_s2clientprotocol_2ferror_2eproto[0];
}
